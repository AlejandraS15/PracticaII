...
guardarParqueadero parqueadero = do
    ...
    appendFile "parqueadero.txt" info
...
listarVehiculos = do
    ...
    putStrLn "Vehiculos en el parqueadero:"
    let lineas = lines contenido
    mapM_ (putStrLn . imprimirVehiculo) lineas

imprimirVehiculo :: String -> String
imprimirVehiculo linea =
    let [placa1, entrada1, salida1] = splitOn "," linea
    in "Vehiculo {Placa: " ++ placa1 ++ ", Hora entrada: " ++ entrada1 ++ ", Hora salida: " ++ salida1 ++ "}"
